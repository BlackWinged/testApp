...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Tatsumaki.data';
    var REMOTE_PACKAGE_BASE = 'Tatsumaki.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3212728;
      var PACKAGE_UUID = '59998018-2dbd-4029-aa1b-944735a304f7';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 257986, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(257986, 258205, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(258205, 262227, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(262227, 2108291, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2108291, 3185103, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3185103, 3212728, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Tatsumaki.data');

    };
    Module['addRunDependency']('datafile_Tatsumaki.data');
